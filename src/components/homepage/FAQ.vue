  ...
  <section class="faq" id="faq">
    <div class="faq-container container">
      ...
      <div class="item">
        <div class="q">
          <b-icon icon="question-square-fill" variant="danger"></b-icon
          >一個人可以參與多個稿件嗎？<br />Can I submit more than one proposals?
        </div>
        <p class="a">
          <b-icon icon="chat-dots" variant="dark"></b-icon
      ...
      <div class="item">
        <div class="q">
          <b-icon icon="question-square-fill" variant="danger"></b-icon
          >是否可以以團隊為單位投稿？如果我們是一個團隊的話，其他人會被列在網站上面嗎？<br />Can
          we submit as a team? If we are a team, will the menbers show on the
          website?
        </div>
        <p class="a">
          <b-icon icon="chat-dots" variant="dark"></b-icon
      ...
      <div class="item">
        <div class="q">
          <b-icon icon="question-square-fill" variant="danger"></b-icon
          >可以多人報名一個短講嗎？<br />Can we have more than one people to
          submit a short talk?
        </div>
        <p class="a">
          <b-icon icon="chat-dots" variant="dark"></b-icon
          >可以。請在投稿系統上，分別列出參與講者的資訊。<br />Sure. Please list
      ...
      <div class="item">
        ...
        <p class="a">
          <b-icon icon="chat-dots" variant="dark"></b-icon
          >請於投稿時備註需求，大會將在考量場地與成本限制之餘，將儘可能協助安排。<br />Please
          leave a note about what you need when submmiting a proposal, we will
          make our best to provide assistence in consideration of the stage and
          costs.
        </p>
      </div>
      <div class="item">
      ...
      <div class="item">
        <div class="q">
          <b-icon icon="question-square-fill" variant="danger"></b-icon
          >我是外國人，大會是否會協助我辦理簽證與入境相關文件？<br />I am a
          foreigner, would g0v Summit assist me to apply visa and entry related
          documentation?
        </div>
        <p class="a">
          <b-icon icon="chat-dots" variant="dark"></b-icon
